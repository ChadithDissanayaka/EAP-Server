...
public class AppointmentController {
                ...
                return ResponseEntity
                                ...
                                .body(StandardResponseDTO.builder()
                                                ...
                                                .data(appointmentService
                                                                .getEmployeeInProgressAppointments(auth.getName()))
                                                .build());
        }
        ...
        public ResponseEntity<StandardResponseDTO> getMyAwaitingPartsAppointments(Authentication auth) {
                return ResponseEntity
                                ...
                                .body(StandardResponseDTO.builder()
                                                ...
                                                .data(appointmentService
                                                                .getEmployeeAwaitingPartsAppointments(auth.getName()))
                                                .build());
        }
        ...
        public ResponseEntity<StandardResponseDTO> getMyCompletedAppointments(Authentication auth) {
                return ResponseEntity
                                ...
                                .body(StandardResponseDTO.builder()
                                                ...
                                                .data(appointmentService
                                                                .getEmployeeCompletedAppointments(auth.getName()))
                                                .build());
        }
        ...
        public ResponseEntity<StandardResponseDTO> updateNotes(
                ...
                return ResponseEntity
                                ...
                                .body(StandardResponseDTO.builder()
                                                ...
                                                .data(appointmentService.updateTechnicianNotes(id,
                                                                dto.getTechnicianNotes()))
                                                .build());
        }
        ...
        public ResponseEntity<StandardResponseDTO> submitQuote(
                ...
                return ResponseEntity
                                ...
                                .body(StandardResponseDTO.builder()
                                                ...
                                                .data(appointmentService.submitQuote(id, dto.getQuotePrice(),
                                                                dto.getQuoteDetails()))
                                                .build());
        }
        ...
        @PreAuthorize("hasAnyRole('EMPLOYEE', 'SHOP_OWNER', 'CUSTOMER')")
        public ResponseEntity<StandardResponseDTO> cancelAppointment(@PathVariable UUID id, Authentication auth) {
                return ResponseEntity
                                ...
                                .body(StandardResponseDTO.builder()
                                                ...
                                                .data(appointmentService.cancelAppointment(id, auth.getName()))
                                                .build());
        }
        ...
        public ResponseEntity<StandardResponseDTO> rejectModificationRequest(
                ...
                return ResponseEntity
                                ...
                                .body(StandardResponseDTO.builder()
                                                ...
                                                .data(appointmentService.rejectModificationRequest(id,
        ...
        public ResponseEntity<StandardResponseDTO> rejectQuote(
                ...
                return ResponseEntity
                                ...
                                .body(StandardResponseDTO.builder()
                                                ...
                                                .data(appointmentService.rejectQuote(id, dto.getRejectionReason(),
                                                                auth.getName()))
                                                .build());
        }
}